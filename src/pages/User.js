...
import PandLGraph from '../_mock/PandLGraph';
      ...
      <Container>
        ...
        <Grid item xs={12} md={6} lg={12} sx ={{ mb: 2 }}>
            <AppWebsiteVisits
              ...
              //   '11/01/2022',
              // ]}
              chartLabels={PandLGraph.PandLDateGraph}
              chartData={[
                {
                  name: 'ITrade',
                  type: 'area',
                  ...
                  data: PandLGraph.PandLpriceGraph
                },
                {
                  ...
                  data: PandLGraph.PandLpriceGraph.map((i)=> Math.round((i*(Math.round(Math.random()*10)/10))*10/10))
                },
              ]}
            />
          </Grid>
